...
def critic_network(env):
    ...
    critic = tf.keras.Model(inputs=[state_input, action_input], outputs=critic, name='critic')
    return critic
...
def main():
    ...
    plot_model(actor, to_file='actor.png')
    plot_model(critic, to_file='critic.png')
